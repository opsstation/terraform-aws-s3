...
module "vpc" {
  source      = "git::git@github.com:opsstation/terraform-aws-vpc"
  name        = "app"
  environment = local.environment
...
module "subnets" {
  source             = "git::git@github.com:opsstation/terraform-aws-subnet"
  name               = "subnet"
  environment        = local.environment
...
module "kms_key" {
  source                  = "git::git@github.com:opsstation/terraform-aws-kms"
  name                    = "kms11"
  environment             = local.environment
  label_order             = local.label_order
  enabled                 = true
